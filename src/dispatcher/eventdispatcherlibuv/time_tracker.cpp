...
void EventDispatcherLibUvTimerTracker::registerTimer(int timerId, int interval, Qt::TimerType timerType,
                                                     QObject *object) {
...
int EventDispatcherLibUvTimerTracker::remainingTime(int timerId) {
    ...
    return timerInfo.interval + timerInfo.lastFired - api->uv_hrtime() / 1000000;
}
